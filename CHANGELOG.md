...
- Fix NPM Package build #106 [#108](https://github.com/jasonrundell/dropship/pull/108) ([@jasonrundell](https://github.com/jasonrundell))
...
- Update README.md with installation instructions and links ([@jasonrundell](https://github.com/jasonrundell))
...
- Merge branch 'main' of https://github.com/jasonrundell/dropship ([@jasonrundell](https://github.com/jasonrundell))
- Reverting node version change ([@jasonrundell](https://github.com/jasonrundell))
