...
all three roles are distinct across all four. Typography is the loudest signal a
design gives off, so two designs sharing a heading face read as variants of one
another however far apart their colour and geometry are.
