...
<Canvas>
  <Story name="All">
    <div>
      <Heading level={1} label="Heading 1" />
      <Heading level={2} label="Heading 2" />
      <Heading level={3} label="Heading 3" />
      <Heading level={4} label="Heading 4" />
      <Heading level={5} label="Heading 5" />
      <Heading level={6} label="Heading 6" />
    </div>
  </Story>
</Canvas>
